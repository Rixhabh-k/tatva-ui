...
const GradientBlinds = ({
  ...
  useEffect(() => {
    ...
    /*
      ...
      Mobile devices can have DPR 2x / 3x.
      Capping it prevents the noise from
      becoming excessively high-frequency.
    */
    ...
    const fragment = `
      ...
      void mainImage(
        ...
        /*
          ================================
          DPR-INDEPENDENT NOISE
          ================================

          Instead of using raw gl_FragCoord,
          normalize it by DPR.

          This keeps grain size consistent
          across high-DPI mobile displays.
        */
